...
function search_weather(event) {
    ...
    let parent_div = document.getElementById("weather_res");
    ...
    xhr.onload = () =>{
        // document.getElementById("weather_res").innerHTML = "";
    ...
    close_btn.onclick = function(){
        ...
        if (document.getElementById("weather_res").childElementCount==0){
